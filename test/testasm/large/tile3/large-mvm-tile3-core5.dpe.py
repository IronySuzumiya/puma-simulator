...
dict_temp = {}
dict_list = []
i_temp = i_set(d1=257, imm=384, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_load(d1=257, r1=257, load_width=16, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_set(d1=385, imm=1024, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_load(d1=0, r1=385, load_width=16, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_set(d1=385, imm=1152, vec=1)
dict_list.append(i_temp.copy())
...
dict_list.append(i_temp.copy())
i_temp = i_set(d1=385, imm=512, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_store(d1=385, r1=257, counter=1, store_width=16, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_hlt()
dict_list.append(i_temp.copy())
filename = 'large/tile3/core_imem5.npy'
