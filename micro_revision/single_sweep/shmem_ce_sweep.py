...
def get_tile_area (xbar_size, num_xbar, num_vfu, num_core, shmem_size):
    core_area = 0.0
    ...
    tile_area += (num_core/8.0) * edram_area * shmem_size
        ...
        for num_xbar in num_xbar_list:
            for num_core in num_core_list:
                for shmem_size in shmem_size_list:
                    tile_area = get_tile_area (xbar_size, num_xbar, num_vfu, num_core, shmem_size)
