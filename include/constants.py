...
# XBAR - Discuss exact values/trends from Gary
...
instrnMem_area =  instrnMem_area_dict[str(cfg.instrnMem_size)]
...
instrnMem_pow_leak =  instrnMem_pow_leak_dict[str(cfg.instrnMem_size)]
...
edram_lat_dict = {'64' : 2, #edram access width is constant = 256 bits
                  '128': 2}

edram_pow_dyn_dict = {'64' : 17.2/2, # (0.0172 nJ with 2 cycles access latency)
                      '128': 25.35/2}

edram_pow_leak_dict = {'64' : 0.46,
                       '128': 0.77}

edram_area_dict = {'64' : 0.086,
                   '128': 0.121}
...
counter_buff_lat = 1
counter_buff_pow_dyn = 0.65/2
counter_buff_pow_leak = 0.33
counter_buff_area = 0.0041

# EDRAM to IMA bus values
edram_bus_lat = 1
edram_bus_pow_dyn = 0.6 #bus width = 384, same as issac
edram_bus_pow_leak = 0.1 #bus width = 384, same as issac
...
receive_buffer_pow_dyn = 4.48 # (0.2*256/16)
receive_buffer_pow_leak = 0.09
receive_buffer_area = 0.0022
...
tile_instrnMem_area = tile_instrnMem_area_dict[str(cfg.tile_instrnMem_size)]
...
tile_instrnMem_pow_dyn = tile_instrnMem_pow_dyn_dict[str(cfg.tile_instrnMem_size)]
...
tile_instrnMem_pow_leak = tile_instrnMem_pow_leak_dict[str(cfg.tile_instrnMem_size)]
