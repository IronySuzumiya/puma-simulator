...
class noc (object):
    ...
    def check_inter (self, src_tileId, dest_tileId):
        inter_flag = 1
        src_nodeId = (src_tileId) / int(cfg.num_tile_max) # integer division (first 2 tiles are i/o tiles)
        dest_nodeId = (dest_tileId) / int(cfg.num_tile_max)
