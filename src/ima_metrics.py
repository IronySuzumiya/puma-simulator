...
def compute_area (): #in mm2
    area = 0.0
    area += cfg.num_xbar/(cfg.data_width/cfg.xbar_bits) * param.xbar_inMem_area # xbar_inMem
    area += (cfg.num_xbar/(cfg.data_width/cfg.xbar_bits) * cfg.xbar_size) * param.dac_area # dac
    ...
    area += cfg.num_xbar/(cfg.data_width/cfg.xbar_bits) * param.xbar_outMem_area # xbar_outMem (1 OR for 8 xbars - 16 bit weights, 2 bit xbars)
...
def compute_pow_leak ():
    leak_pow = 0.0
    leak_pow += cfg.num_xbar/(cfg.data_width/cfg.xbar_bits) * param.xbar_inMem_pow_leak # xbar_inMem
    leak_pow += (cfg.num_xbar/(cfg.data_width/cfg.xbar_bits) * cfg.xbar_size) * param.dac_pow_leak # dac
    ...
    leak_pow += cfg.num_xbar/(cfg.data_width/cfg.xbar_bits) * param.xbar_outMem_pow_leak # xbar_outMem
...
def compute_pow_dyn ():
    dyn_pow = 0.0
    dyn_pow += (cfg.num_xbar/(cfg.data_width/cfg.xbar_bits)) * (param.xbar_inMem_pow_dyn_write + param.xbar_inMem_pow_dyn_read/cfg.xbar_size) # xbar_inMem - num_xbar * dac_res bits will be
    ...
    dyn_pow += (cfg.num_xbar/(cfg.data_width/cfg.xbar_bits) * cfg.xbar_size) * param.dac_pow_dyn # dac
    ...
    dyn_pow += cfg.num_xbar/(cfg.data_width/cfg.xbar_bits) * param.xbar_outMem_pow_dyn # xbar_outMem (1 OR for 8 xbars - 16 bit weights, 2 bit xbars)
